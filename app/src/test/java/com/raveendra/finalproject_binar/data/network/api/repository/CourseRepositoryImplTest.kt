...
import com.raveendra.finalproject_binar.data.response.detaildata.detaildatanew.Chapter
import com.raveendra.finalproject_binar.data.response.detaildata.detaildatanew.Content
import com.raveendra.finalproject_binar.data.response.detaildata.detaildatanew.CourseApiResponseNew
import com.raveendra.finalproject_binar.data.response.detaildata.detaildatanew.Data
...
class CourseRepositoryImplTest {
    ...
    fun `getCategories, with result success`() {
        ...
        runTest {
            ...
            repository.getCourse(1, "Free").map {
                delay(100)
                it
            }.test {
                delay(220)
